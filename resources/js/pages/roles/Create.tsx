                    ...
                    <div>
                        ...
                        {permissions.map((permissions) => (
                            <label key="1" className="flex items-center space-x-2">
                                <input type="checkbox" className="form-checkbox h-5 w-5 rounded text-blue-600 focus:ring-1 focus:ring-2"
                                value={permissions}
                                id={permissions}
                                onChange={(e)=>handleCheckboxChange(permissions, e.target.checked)}
                                />
                                <span className="text-gray-800 capitalize">{permissions}</span>
                            </label>
                        ))}
